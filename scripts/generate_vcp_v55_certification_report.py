#!/usr/bin/env python3
# =============================================================================
# scripts/generate_vcp_v55_certification_report.py
# V5.5 Accumulation / VCP Sample-Expansion & Ablation Institutional Report
# =============================================================================
...
_CSV_PATH = os.path.join(_REPO_ROOT, "reports", "vcp_v55_sample_expansion_outcomes.csv")
...
def compute_vcp_metrics(df_subset):
    n = len(df_subset)
    if n == 0:
        return {
...
def main():
    ...
    sum_df.to_csv(os.path.join(_REPO_ROOT, "reports", "vcp_v55_summary_matrix.csv"), index=False)
    print(f"\nSummary matrix saved to reports/vcp_v55_summary_matrix.csv")
