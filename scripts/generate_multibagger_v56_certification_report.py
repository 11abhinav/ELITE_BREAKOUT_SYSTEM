#!/usr/bin/env python3
# =============================================================================
# scripts/generate_multibagger_v56_certification_report.py
# V5.6 Multibagger Convexity Institutional Report Generator
# =============================================================================
...
_CSV_PATH = os.path.join(_REPO_ROOT, "reports", "multibagger_v56_convexity_outcomes.csv")
...
def main():
    ...
    sum_df.to_csv(os.path.join(_REPO_ROOT, "reports", "multibagger_v56_summary_matrix.csv"), index=False)
    print(f"\nSummary matrix saved to reports/multibagger_v56_summary_matrix.csv")
