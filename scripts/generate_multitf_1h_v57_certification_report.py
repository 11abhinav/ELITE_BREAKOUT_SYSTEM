#!/usr/bin/env python3
# =============================================================================
# scripts/generate_multitf_1h_v57_certification_report.py
# V5.7 Multi-TF 1H Quality Recovery Institutional Report Generator
# =============================================================================
...
_CSV_PATH = os.path.join(_REPO_ROOT, "reports", "multitf_1h_v57_quality_outcomes.csv")
...
def main():
    ...
    sum_df.to_csv(os.path.join(_REPO_ROOT, "reports", "multitf_1h_v57_summary_matrix.csv"), index=False)
    print(f"\nSummary matrix saved to reports/multitf_1h_v57_summary_matrix.csv")
