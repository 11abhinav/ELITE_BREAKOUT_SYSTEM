#!/usr/bin/env python3
# =============================================================================
# scripts/generate_multitf_1h_v56_certification_report.py
# V5.6 Multi-TF 1H Depth-Expansion & Ablation Institutional Report
# =============================================================================
...
_CSV_PATH = os.path.join(_REPO_ROOT, "reports", "multitf_1h_v56_expansion_outcomes.csv")
...
def compute_m1h_metrics(df_subset):
    n = len(df_subset)
    if n == 0:
        return {
...
def main():
    ...
    sum_df.to_csv(os.path.join(_REPO_ROOT, "reports", "multitf_1h_v56_summary_matrix.csv"), index=False)
    print(f"\nSummary matrix saved to reports/multitf_1h_v56_summary_matrix.csv")
