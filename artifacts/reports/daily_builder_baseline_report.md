# Baseline Report: DAILY_BUILDER (Intraday Momentum)
...
|---|---|---|
| **Total Telemetry Records** | **35** | Total candidate alert records ingested |
| **Production-Valid Outcomes** | **0** | Strictly clean non-zero geometry replays |
| **Excluded Invalid Records** | **35** | Excluded due to mock levels / zero targets |
...
| **Unique Trading Days** | **1** | Calendar trading sessions covered |
...
> **Primary Blocker:** 35 records require intraday forward price path rehydration and session close semantics.
