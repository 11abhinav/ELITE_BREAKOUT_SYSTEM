...
def run_pullback_pipeline(run_date: str = None, force: bool = False, session=None, run_ctx=None, used_fallback_data: bool = False) -> int:
    ...
    # 30-day prior alerts for evidence bonus calculation (+3 for EOD, +2 for MULTIBAGGER)
    ...
    prior_multi_symbols = {s for (s, _) in get_recent_alerts_for_scanner("MULTIBAGGER", prior_window_mins, only_active=True)}
