...
# TECHNICAL SCANNER (BOTTOM SHAKEOUT & BULLISH ABSORPTION) — Daily 16:00 IST (4:00 PM IST)
#
# RULE 67 MANDATORY CHANGE-RATIONALE:
# - Implemented full production-grade Technical Scanner conforming to system architectural standards.
...
# - Complies with full execution run contexts, scanner health tracking, process locking,
#   and real-time alerts exit monitoring.
# =====================================================================================
...
def detect_technical_setup(df: pd.DataFrame, symbol: str) -> Optional[Dict[str, Any]]:
    ...
    Stage 3 — Bullish Re-Absorption / Engulfing:
      ...
      - Bullish body >= Prev bearish body * 0.85.
...
def run_technical_scan(
    ...
    """
    Main Execution Entry Point for TECHNICAL Scanner.
    ...
    logger.info("=" * 70)
    logger.info("🚀 TECHNICAL SCANNER | Starting 4:00 PM Bottom Absorption Execution...")
    logger.info("=" * 70)
    ...
    try:
        ...
        upsert_scanner_health(
            scanner_name="TECHNICAL",
            status="RUNNING",
            error_msg="Technical Bottom Absorption scan in progress...",
        ...
        for cand in qualified_candidates:
            ...
            logger.info(
                f"🔥 [TECHNICAL ALERT TRIGGERED] {sym} | CMP: ₹{cmp_price:.2f} | Type: {engulf_type} | "
