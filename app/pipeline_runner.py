...
class PipelineRunner:
    ...
    def _execute_internal(
        ...
        if not rejection_reason:
            ...
            elif volume_ratio < EOD_CONFIG["MIN_VOLUME_RATIO"]: rejection_reason = "low_volume"
            ...
            elif _safe_float(latest.get("PRIOR_20D_HIGH")) <= 0 or candle_close <= _safe_float(latest.get("PRIOR_20D_HIGH")): rejection_reason = "no_structural_breakout"
            ...
            elif candle_close < _safe_float(latest.get("SMA50")): rejection_reason = "below_sma50"
